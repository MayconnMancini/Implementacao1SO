...
public class Processo {
    ...
    public String toString() {
        return "Processo{" + "id=" + id + ", tempo_entrada=" + tempo_entrada + ", tempo_execucao=" + tempo_execucao + ", prioridade=" + prioridade + ", tempo_comeco_execucao=" + tempo_comeco_execucao + ", tempo_terminou_execucao=" + tempo_terminou_execucao + '}';
    }
